                        ...
                        <tbody>
                            <tr v-for="(order, index) in orders.data" :key="index" class="border-b dark:border-gray-700 text-center">
                                ...
                                <td class="flex justify-center gap-4">
                                    ...
                                    <a  @click.prevent="openEditModal(order)"
                                        :disabled="isLoading"
                                        class="flex items-center justify-center w-12 h-12 text-white bg-pink-800 rounded-lg hover:bg-pink-600 transition">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
...
<script setup>
    ...
    const openEditModal = (order) => {
        router.visit(route('admin.orders.update-page', order.id));
    };
</script>
