<template>
    <section>
        <div id="updateProductModal" tabindex="-1" aria-hidden="true" :class="visible ? 'flex' : 'hidden' "
            class="overflow-y-auto overflow-x-hidden fixed top-50 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
